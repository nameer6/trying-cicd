...
const LockRevealModal = ({
  ...
  const renderProfileName = () => {
    ...
    switch (sharedBy.length) {
      case 1:
        text = sharedBy[0]?.full_name?.trim()?.trim();
        break;
      case 2:
        text =
          sharedBy[0]?.full_name?.trim() +
          ' and ' +
          sharedBy[1]?.full_name?.trim();
        break;
      case 3:
        text =
          sharedBy[0]?.full_name?.trim() +
