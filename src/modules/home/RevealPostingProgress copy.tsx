...
const RevealPostingProgress = React.memo(({unLockedReveals}: Props) => {
  ...
  const uploadPost = useCallback(async () => {
    ...
    //   },
    // );
    // console.log('SHARE REVEAL RES: ' + JSON.stringify(response));
  ...
  //   return {
  //     opacity: withTiming(revealToPost ? 1 : 0, {
  //       duration: 500,
  ...
  return (
    <Animated.View
      style={[styles.progressStatusContainer]}
      exiting={FadeOut.duration(500).easing(Easing.linear)}>
